...
AWS_ACCESS_KEY_ID = "AKIASAT5BB2A4M3OFDYW"
AWS_SECRET_ACCESS_KEY = "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"
...
if status == 200:
    ...
    name=hb_df.loc[(hb_df['Gender'] == "f")  & (hb_df['Hb (g/dl)'] < 13) & ((hb_df['BILIRUBIN (mg/dL)'] < 0.3) | (hb_df['BILIRUBIN (mg/dL)'] > 1.2))]
